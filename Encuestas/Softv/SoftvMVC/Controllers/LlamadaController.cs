...
namespace SoftvMVC.Controllers
{
    ...
    public partial class LlamadaController : BaseController, IDisposable
    {
        ...
        public ActionResult QuickIndex(int? page, int? pageSize, bool? Tipo_Llamada, String Detalle, String Solucion, DateTime? Fecha, DateTime? HoraInicio, DateTime? HoraFin, int? IdQueja, int? IdUsuario, int? IdTurno, int? IdConexion, int? Clv_Trabajo, int? Clv_TipSer, int? Contrato)
        {
            int pageNumber = (page ?? 1);
            int pSize = pageSize ?? SoftvMVC.Properties.Settings.Default.pagnum;
