...
namespace Softv.DAO
{
    ...
    public class UniversoEncuestaData : UniversoEncuestaProvider
    {
        ...
        //public override UniversoEncuestaEntity ActualizarUniverso(int? Id)
        //{
        //    using (SqlConnection connection = new SqlConnection(SoftvSettings.Settings.UniversoEncuesta.ConnectionString))
        //    {
        ...
        public override int ActualizarUniverso(int? Id)
        {
            int result = 0;
            using (SqlConnection connection = new SqlConnection(SoftvSettings.Settings.UniversoEncuesta.ConnectionString))
            {

                SqlCommand comandoSql = CreateCommand("ActualizaUniverso", connection);

                AssingParameter(comandoSql, "@IdUniverso", Id);
